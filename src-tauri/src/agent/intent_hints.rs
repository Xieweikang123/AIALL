...
use super::exploration::{
  build_code_review_honesty_nudge, build_implement_follow_up_hint, build_same_issue_follow_up_hint,
  build_ultra_short_open_task_hint, build_user_error_quote_hint, build_user_failure_report_nudge,
};
...
pub fn build_interactive_build_hints(
  ...
  if policy.code_review_run {
    parts.push(build_code_review_honesty_nudge(user_recently_reported_failure));
  }
