...
import { useKnowledgePanelUi } from "../../composables/useKnowledgePanelUi";
import {
...
const editingRef = computed(() => props.editing);
const exploreRunningRef = computed(() => props.exploreRun.running);
...
const {
  ...
  layout: layoutRef,
  editing: editingRef,
  exploreRunning: exploreRunningRef,
  tocSections,
  bodyRef,
  bodyScrollRef,
  tocNavRef,
...
<style src="./styles/KnowledgePanel.scss" scoped></style>
