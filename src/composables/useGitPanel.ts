...
export function useGitPanel(
  ...
  return {
    ...
    refreshGitStatus: statusRefresh.refreshGitStatus,
    refreshIgnoredLocalFiles: statusRefresh.refreshIgnoredLocalFiles,
    ...
    ignoreSelectedFiles: stagingActions.ignoreSelectedFiles,
    unignoreSelectedFiles: stagingActions.unignoreSelectedFiles,
